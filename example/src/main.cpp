...
int main(int argc, char *argv[])
{
    ...
    auto version_fn = reinterpret_cast<void (*)(sdk_context)>(tmp);
    ...
    auto init_fn = reinterpret_cast<void (*)(sdk_context)>(tmp);
    ...
    auto subscribe_fn = reinterpret_cast<void (*)(sdk_context)>(tmp);
    ...
    auto query_fn = reinterpret_cast<void (*)(sdk_context)>(tmp);
